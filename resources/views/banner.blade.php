           ...
           <div class="container">
               <div class="row fullscreen align-items-center justify-content-between">
                   <div class="col-lg-6 col-md-6 banner-left">
                       ...
                       <h1 class="text-white">Filter Flight</h1>
                       <p class="text-white">
                       ...
                       <a href="{{ url('/about') }}" class="primary-btn text-uppercase">Read More</a>
                   </div>
                   <div class="col-lg-4 col-md-6 banner-right mt-100">
                       ...
                       <div class="tab-content" id="myTabContent">
                           ...
                           {{-- <div class="tab-pane fade show active" id="flight" role="tabpanel" aria-labelledby="flight-tab">
                            <form class="form-wrap" action="{{ Route('add.flight') }}" method="POST">
                                @csrf
                        
                                <!-- Radio buttons for trip type -->
                                <div class="form-check-inline">
                                    <input class="form-check-input" type="radio" name="trip_type" id="singleTrip" value="singleTrip" onclick="toggleReturnInput()" checked>
                                    <label class="form-check-label" for="singleTrip">Single Trip</label>
                                </div>
                                <div class="form-check-inline">
                                    <input class="form-check-input" type="radio" name="trip_type" id="roundTrip" value="roundTrip" onclick="toggleReturnInput()">
                                ...
                                <input type="text" class="form-control date-picker" name="return" id="returnInput" placeholder="Return"
                                    onfocus="this.placeholder = ''" onblur="this.placeholder = 'Return'" style="display: none;">
                        ...
                        // Initialize the form with the correct visibility based on the default selected radio button
                        document.addEventListener('DOMContentLoaded', function() {
                           ...
                           <div class="tab-pane fade show active" id="flight" role="tabpanel"
                               ...
                               <form class="form-wrap" action="{{ url('/home-mail') }}" method="POST">
                                @csrf
                                <input type="text" class="form-control" name="from" placeholder="From "
                                       onfocus="this.placeholder = ''" onblur="this.placeholder = 'From '" required>
                                @error('from')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            
                                <input type="text" class="form-control" name="to" placeholder="To "
                                       onfocus="this.placeholder = ''" onblur="this.placeholder = 'To '" required >
                                @error('to')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            
                                <input type="text" class="form-control date-picker" name="start"
                                       placeholder="Depart " onfocus="this.placeholder = ''"
                                       onblur="this.placeholder = 'Start '" required >
                                @error('start')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
           ...
           <div class="container">
               <div class="row align-items-center justify-content-end">
                   <div class="col-lg-6 col-md-12">
                       ...
                       <a href="{{ url('/contact') }}" class="primary-btn text-uppercase">Request Connect</a>
                   </div>
